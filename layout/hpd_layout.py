...
- Vehicles / large furniture (bus, train, sofa): large (≈25–45%), bottom-anchored, wider.
- Animals / people (sheep, dog, person): medium (≈12–25%).
- Handhelds / accessories / fruits (cell phone, handbag, banana): small (≈2–10%).
- Tall slim objects (umbrella, streetlight): tall aspect; align to one side.
